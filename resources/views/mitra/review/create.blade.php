...
@section('title', 'Tambah Review - SJAM GAMA FARM')
...
<div class="flex h-full">
    ...
    <div class="flex-1 overflow-y-auto bg-gray-100 p-6">
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="mb-6">
                <h1 class="text-2xl font-semibold text-gray-800">Tambah Review</h1>
                <p class="text-gray-600">Tambahkan review baru untuk dibagikan</p>
            </div>

            <form action="{{ route('mitra.reviews.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <div class="flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg p-6 mb-2">
                        <div id="imagePreview" class="hidden mb-4">
                            <img src="#" alt="Preview" class="max-h-48 max-w-full">
                        </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        ...
                        placeholder="Tulis deskripsi review disini...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
