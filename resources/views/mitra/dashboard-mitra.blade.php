...
<div class="h-full overflow-y-auto">
    <div class="flex h-full">
        ...
        <!-- Main Content -->
        <div x-data="{ open: false, title: '' }" class="flex-1 bg-gradient-to-b from-green-600 to-green-900 p-8 overflow-hidden h-full">
                ...
                <div class="text-center">
                    ...
                    <template x-if="title === 'Hidroponik'">
                        <ul class="space-y-3">
                            ...
                            <li>
                                <a href="#" class=" py-3 px-4 text-white hover:bg-green-600 rounded-lg transition-colors duration-200 flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
